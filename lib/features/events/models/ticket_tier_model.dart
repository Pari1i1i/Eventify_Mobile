class TicketTierModel {
  ...
  bool get isSoldOut => remainingQuota <= 0;
  ...
  factory TicketTierModel.fromJson(Map<String, dynamic> json) {
    return TicketTierModel(
      ...
      startSales: json['start_sales'] != null ? DateTime.tryParse(json['start_sales'].toString()) : null,
      endSales: json['end_sales'] != null ? DateTime.tryParse(json['end_sales'].toString()) : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'start_sales': startSales?.toIso8601String(),
      'end_sales': endSales?.toIso8601String(),
    };
  }
}
